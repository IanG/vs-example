          ...
          QuestionGroups = [
              new()
              {
                    ...
                    Questions = [
                        ...
                        new StringQuestion() { Id = 3, Order = 3, CapturesField = "WhyYouLoveMumber7", Prompt = "Seems like you like the number 7, tell us why", Placeholder = "Why do you love number 7 ?", MinLength = 1, MaxLength = 7, HelpText = "Tell us why you love the number 7", Required = true, InvalidDataMessage = "Give us the reason", VisbilityRule = "FaveNumber == 7"},
                        new StringQuestion() { Id = 4, Order = 4, CapturesField = "WhyYouLoveMumber7Additional", Prompt = "Tell us more about the number 7 !!!", Placeholder = "Big up the number 7", MinLength = 1, MaxLength = 2, HelpText = "Tell us more about your love of the number 7", Required = true, InvalidDataMessage = "Give us the reason", VisbilityRule = "FaveNumber == '7'"},
                        new StringQuestion() { Id = 5, Order = 5, CapturesField = "Number5Answer", Prompt = "Seems like you prefer the number 5 - tell us why", Placeholder = "Explain why you prefer the number 5", MinLength = 1, MaxLength = 2, HelpText = "Ok, so you prefer number 5 to number 7 - tell us why", Required = true, InvalidDataMessage = "Please complete this field", VisbilityRule = "FaveNumber == '5'"}
                    ]
              },
              new()
              {
